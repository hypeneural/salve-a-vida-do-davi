...
const TransparencySection = () => {
  ...
  return (
    <section id="transparencia" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Nossa promessa é absoluta transparência. Cada centavo doado será usado exclusivamente 
            para o tratamento do Davi e custos diretamente relacionados.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <Card className="p-8 border-2 border-davi-blue/30">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Acesso completo a todos os documentos médicos e financeiros da campanha
              </p>
            </div>
            
            <div className="space-y-4">
              {documents.map((doc, index) => (
                <div key={index} className="bg-white p-4 rounded-lg border border-gray-200 hover:border-davi-blue/30 transition-colors cursor-pointer">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600 text-center">
                📄 Todos os documentos são verificados e atualizados regularmente
              </p>
            </div>
          </Card>
          ...
          <Card className="p-8 border-2 border-davi-yellow/30">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Breakdown detalhado de como cada real será utilizado
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="p-8 bg-gradient-to-br from-davi-green-light/5 to-davi-blue/5 border-2 border-davi-green-light/30">
            ...
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-davi-green-light rounded-full mt-2 flex-shrink-0"></div>
                <p>
                  <strong>100% dos recursos</strong> serão destinados exclusivamente ao tratamento do Davi
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-davi-blue rounded-full mt-2 flex-shrink-0"></div>
                <p>
                  <strong>Relatórios mensais</strong> de prestação de contas serão publicados
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-davi-yellow rounded-full mt-2 flex-shrink-0"></div>
                <p>
                  <strong>Documentos médicos</strong> e comprovantes sempre disponíveis
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-davi-green-dark rounded-full mt-2 flex-shrink-0"></div>
                <p>
                  <strong>Canal direto</strong> para esclarecimento de dúvidas
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-8 bg-gradient-to-br from-davi-yellow/5 to-davi-green-light/5 border-2 border-davi-yellow/30">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600 text-center">
                📞 Respondemos todas as dúvidas em até 24 horas
              </p>
            </div>
          </Card>
        </div>
