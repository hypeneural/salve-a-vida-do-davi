...
const MediaSection = () => {
  const mediaItems = [
    ...
    {
      id: 2,
      title: "Você pode ajudar! menino de Canelinha precisa de R$ 17 milhões para tratamento de doença",
      ...
      date: "2024-12-10",
      summary: "Portal local destaca a campanha solidária para ajudar o menino Davi Luiz em sua luta contra a DMD.",
      category: "Reportagem",
      type: "article"
    },
    {
      id: 3,
      title: "Menino de Canelinha com doença rara precisa de remédio de R$ 17 milhões e busca ajuda",
      ...
      date: "2024-12-12",
      summary: "Cobertura completa sobre a condição rara do Davi e a urgência do tratamento antes dos 7 anos de idade.",
      category: "Reportagem",
      type: "article"
    },
    {
      id: 4,
      title: "A Corrente do Bem por Davi Luiz: Sua Ajuda na Fatura de Água!",
      ...
      date: "2025-01-15",
      summary: "Iniciativa da Câmara Municipal de Canelinha para facilitar doações através da fatura de água dos cidadãos.",
    ...
    },
    {
      ...
      date: "2024-12-08",
      summary: "Vídeo-reportagem completa sobre a história do Davi e a mobilização da comunidade para ajudá-lo.",
      category: "Vídeo-Reportagem",
      type: "video"
    }
  ];
                    ...
                    <CardContent className="pt-0 flex flex-col justify-between flex-grow">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-sm text-gray-500">
                          {item.type === 'video' ? '🎥' : '📰'} {item.type === 'video' ? 'Vídeo' : 'Imprensa'}
                        </div>
                      </div>
                    </CardContent>
                  </Card>
